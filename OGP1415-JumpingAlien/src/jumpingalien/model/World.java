...
/**
 * A class of world , involving alien, plant and slimes.
...
public class World implements Cloneable {
	...
	/**
	 * Adds the plant to the collection of the Plant.
	 * @param plant
	 *        The to be added into the list.
	 * @pre.  The total number of objects in the game world must always be
	 *        less than 100.
	 *        |this.hasValidNumberOfObjects()
	 * @pre   The game must not be started in order to add new objects to the game world.
	 *        |!(this.isGameStarted())
	 * @post. Adds the new plant to the list of the plants.
	...
	private boolean hasValidNumberOfObjects() {
		return this.getNumberOfObjects()+1 < 100;
	}



	/**
	 * A setter to set and update the number of object in th game world.
	...
	public void setInvisibleWorldObject(WorldObjects object) {
		...
		object = null; // help with garbage collection ;-)
	}

	/**
	 * A remover to remove mazub from the given world.
	 * @param   mazub
	 *          The given alien to be removed.
	 * @post.   sets the reference of alien to null.
	 *          |mazub = null
	 * @effect  Sets the gameover true.
	 *          |this.setIsGameOver(true)
	 * @post    After removing the alien total number of objects will be decreased.
	 *          |new.getNumberOfObjects() == this.getNumberOfObects() - 1       
     * @throws NullPointerException 
     *          Throws Null pointer exception if has null reference.
     *          |if(mazub == null)
     *          | throw new NullPointerException();
     */
	public void removeMazub(Mazub mazub) throws NullPointerException {
	  if(mazub == null)
		 throw new NullPointerException();
      mazub = null;
      this.setIsGameOver(true);
